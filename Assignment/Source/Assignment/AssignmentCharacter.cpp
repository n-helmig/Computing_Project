...
void AAssignmentCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AAssignmentCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AAssignmentCharacter::TouchStopped);
...
{
	// If Assignment is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Assignment.Build.cs is not automatically propagated
